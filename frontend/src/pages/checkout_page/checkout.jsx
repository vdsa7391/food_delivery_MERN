  ...
  const onSubmitHandler = async (e) => {
    ...
    if (token) {
      let k = await axios.post(
        url + "/api/order/placeOrderWithToken",
        orderData,
        { headers: { token } }
      );
      if (k.data.success) {
        ...
        <form onSubmit={onSubmitHandler} className="order_delivery_details">
          <div id="form_1">
            ...
            <textarea
              ...
              rows="4"
              cols="50"
              placeholder="Note sull'ordine, ad esempio"
            ></textarea>
          </div>
          ...
          <div className="order" id="form_2">
              ...
              return (
                <div key={index} className="order_box1">
                  <div className="fp_title">
                    {main_cart[food_id]["title"]}
                    <LiaTimesSolid /> {main_cart[food_id]["count"]}
                  </div>
                  <div>
                    {main_cart[food_id]["count"] * main_cart[food_id]["price"]}{" "}
                    €
                  </div>
                </div>
              );
            ...
            <button type="submit" className="order_detail_btn">
              Effettua ordine
            </button>
          </div>
        </form>
